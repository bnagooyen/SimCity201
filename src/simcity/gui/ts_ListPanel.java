 ...
 */
public class ts_ListPanel extends JPanel implements ActionListener {
    ...
    private ts_SimCityPanel simcityPanel;
    private String type;
     ...
     */
    public ts_ListPanel(ts_SimCityPanel rp, String type) {
    	CityGui city;
    	JLabel text;
