...
public class KCustomerRole extends Role implements KCustomer{
	 ...
	 */
	public KCustomerRole(SimCityGui gui){
		//super(p);
		//this.name = name;
		this.hungry = hungry;
		this.gui = gui;
...
//					if(money>=0 && money<=20) {
//						myCash = money;
//						System.out.println(myPerson.getName() + ": " +"I've got $" +myCash);
//					}
//				}
...
//					System.out.println(myPerson.getName() + ": " +"I'm impatient and don't wanna wait");
//					willWait = false;
//				}
//			}
//			count++;
//		}
	...
	private void orderFood() {
		if(choice.equals("TooExpensive")) {
			...
			gui.myPanels.get("Restaurant 1").panel.addGui(orderGui);
