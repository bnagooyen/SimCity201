...
public class KMovingFoodGui implements KGui{
    ...
    public static final int xplate = 655;
	...
	public KMovingFoodGui(KCookRole c, KWaiterRole w, KRestaurantGui gui, int ypos, String s){ //HostAgent m) {
		cook = c;
		agent = w;
		xPos = 700;
		this.yPos = 100;
